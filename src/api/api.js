...
export const getAllMassApply = params => { return axios.get( `MassController/selectMassApply`, { params: params }); };
export const updateMassApply = params => { return axios.get( `MassController/updateMassApply`, { params: params }); };
